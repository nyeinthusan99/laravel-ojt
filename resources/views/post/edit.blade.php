...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-md-8">
        <div class="fw-bold mt-5">Edit Post</div>
            ...
            <div class="form-group row my-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="status" value="1" {{ $post->status == 1 ? 'checked' : '' }}>
                    </div>
                </div>
            </div>
