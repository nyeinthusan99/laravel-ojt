    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <form method="POST" action="{{ route('userProfileUpdate.store') }}" id="myForm"
                    ...
                    <div class="form-group row my-3">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="text" class="form-control" name="name" readonly="readonly"
                                value="{{ session('editUserData')['name'] }}">
                            @error('name')
                    ...
                    <div class="form-group row my-3">
                        ...
                        <div class="col-md-6">
                            <input id="email" type="email" class="form-control" name="email" readonly="readonly"
                                value="{{ session('editUserData')['email'] }}">
                            @error('email')
                                <span class="text-danger" id="err">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row my-3">
                        ...
                        <div class="col-md-6">
                            <input id="phone" type="text" class="form-control" name="phone" readonly="readonly"
                                value="{{ session('editUserData')['phone'] }}">
                            @error('phone')
                                <span class="text-danger" id="err">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row my-3">
                        ...
                        <div class="col-md-6">
                            <input id="dob" max="<?= date('Y-m-d') ?>" type="date" class="form-control"
                                name="dob" readonly="readonly" value="{{ session('editUserData')['dob'] }}">
                            @error('dob')
                                <span class="text-danger" id="err">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row my-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div id="previewImage">
                                ...
                                @else
                                    <img class="img-fluid w-50 h-50" src="{{ asset('storage/man.png') }}"
