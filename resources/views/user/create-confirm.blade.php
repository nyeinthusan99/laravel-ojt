            ...
            <div class="col-md-8">
                ...
                <form method="POST" action="{{ route('user.store') }}" id="myForm">
                    ...
                    <div class="form-group row my-3">
                        <label for="name" class="col-md-4 col-form-label text-md-right required">Name<span
                                class="text-danger ms-2">*</span></label>

                        <div class="col-md-6">
                            <input id="name" type="text" class="form-control" name="name" readonly="readonly"
                                value="{{ session('createUserData')['name'] }}">
                            @error('name')
                    ...
                    <div class="form-group row my-3">
                        <label for="email" class="col-md-4 col-form-label text-md-right required">Email Address<span
                                class="text-danger ms-2">*</span></label>

                        <div class="col-md-6">
                            <input id="email" type="email" class="form-control" name="email" readonly="readonly"
                                value="{{ session('createUserData')['email'] }}">
                            @error('email')
                                <span class="text-danger" id="err">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row my-3">
                        ...
                        <div class="col-md-6">
                            <input id="password" type="password" class="form-control" name="password" readonly="readonly"
                                value="{{ session('createUserData')['password'] }}">
                            @error('password')
                                <span class="text-danger" id="err">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row my-3">
                        ...
                        <div class="col-md-6">
                            <input id="confirmPassword" type="password" class="form-control" name="confirmPassword"
                                readonly="readonly" value="{{ session('createUserData')['confirmPassword'] }}">
                    ...
                    <div class="form-group row my-3">
                        ...
                        <div class="col-md-6">
                            <input id="phone" type="text" class="form-control" name="phone" readonly="readonly"
                                value="{{ session('createUserData')['phone'] }}">
                            @error('phone')
                                <span class="text-danger" id="err">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row my-3">
                        ...
                        <div class="col-md-6">
                            <input id="dob" max="<?= date('Y-m-d') ?>" type="date" class="form-control"
                                name="dob" readonly="readonly" value="{{ session('createUserData')['dob'] }}">
                            @error('dob')
                                <span class="text-danger" id="err">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row my-3">
                        ...
                        <div class="col-md-6">
                            <textarea id="address" type="text" class="form-control" name="address" readonly="readonly"
                                value="{{ session('createUserData')['address'] }}">{{ session('createUserData')['address'] }}</textarea>
                            @error('address')
                                <span class="text-danger" id="err">{{ $message }}</span>
                            @enderror
                        </div>
